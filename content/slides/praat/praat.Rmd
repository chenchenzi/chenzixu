...
.big[Lab Skillz Workshop, Phonetics Laboratory, University of Oxford]
...
**Advanced**: If we manually corrected some pitch points in the PitchTier of a sound file, how do we extract and save the updated pitch track? 
