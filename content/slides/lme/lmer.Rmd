...
1. Fixed effects: Report **significance** (test statistic, degrees of freedom, $p$-value) and **actual estimates** for coefficients (effect size: magnitude and direction, standard errors, and confidence intervals).
