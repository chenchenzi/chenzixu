...
---
# Assumptions check:
.pull-left[### (4) Normality of residuals
...
.pull-right[### (5) Absence of influential data points
```{r comment='#'}
dfbeta(model)
```
...
- Run the analysis **with** influential data and then again **without** them
]
...
---
# Understanding the output of a LME model
